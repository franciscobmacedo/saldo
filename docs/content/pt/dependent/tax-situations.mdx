...
console.log('=== Exemplos TABLE1 ===');
console.log(\`Solteiro - Líquido: €\${single.net.salary.toFixed(2)}\`);
console.log(\`Casado 2 titulares - Líquido: €\${marriedTwoHolders.net.salary.toFixed(2)}\`);
console.log(\`Casado com filhos - Líquido: €\${marriedWithKids.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Pai/Mãe Solteiro(a) - Líquido: €\${singleParent.net.salary.toFixed(2)}\`);
console.log(\`Benefícios Fiscais: €\${singleParent.bracket.deduction.toFixed(2)}\`);`} />
...
console.log('=== Exemplos TABLE3 ===');
console.log(\`Casado Rendimento Único - Líquido: €\${marriedSingleIncome.net.salary.toFixed(2)}\`);
console.log(\`Casado com Filhos - Líquido: €\${marriedWithKids.net.salary.toFixed(2)}\`);`} />
...
console.log('=== Exemplos TABLE4 ===');
console.log(\`Solteiro com Deficiência - Líquido: €\${singleDisabled.net.salary.toFixed(2)}\`);
console.log(\`Casado com Deficiência - Líquido: €\${marriedDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Pai/Mãe Solteiro(a) com Deficiência - Líquido: €\${singleParentDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Casado Dois Titulares com Deficiência - Líquido: €\${marriedTwoHoldersDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Casado Rendimento Único com Deficiência - Líquido: €\${marriedSingleIncomeDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Salário Líquido: €\${partnerDisabled.net.salary.toFixed(2)}\`);
console.log(\`Dedução Adicional: €\${partnerDisabled.bracket.var2_deduction.toFixed(2)}\`);`} />
...
console.log(\`Salário Líquido: €\${familyWithDisabledDependent.net.salary.toFixed(2)}\`);
console.log(\`Dedução de Dependente: €\${familyWithDisabledDependent.bracket.dependent_aditional_deduction.toFixed(2)}\`);`} />
