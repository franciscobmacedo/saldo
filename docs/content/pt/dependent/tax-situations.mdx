...
console.log(\`Solteiro - Líquido: €\${single.netSalary.toFixed(2)}\`);
console.log(\`Casado 2 titulares - Líquido: €\${marriedTwoHolders.netSalary.toFixed(2)}\`);
console.log(\`Casado com filhos - Líquido: €\${marriedWithKids.netSalary.toFixed(2)}\`);`} />
...
console.log(\`Pai/Mãe Solteiro(a) - Líquido: €\${singleParent.netSalary.toFixed(2)}\`);
...
console.log(\`Casado Rendimento Único - Líquido: €\${marriedSingleIncome.netSalary.toFixed(2)}\`);
console.log(\`Casado com Filhos - Líquido: €\${marriedWithKids.netSalary.toFixed(2)}\`);`} />
...
console.log(\`Solteiro com Deficiência - Líquido: €\${singleDisabled.netSalary.toFixed(2)}\`);
console.log(\`Casado com Deficiência - Líquido: €\${marriedDisabled.netSalary.toFixed(2)}\`);`} />
...
console.log(\`Pai/Mãe Solteiro(a) com Deficiência - Líquido: €\${singleParentDisabled.netSalary.toFixed(2)}\`);`} />
...
console.log(\`Casado Dois Titulares com Deficiência - Líquido: €\${marriedTwoHoldersDisabled.netSalary.toFixed(2)}\`);`} />
...
console.log(\`Casado Rendimento Único com Deficiência - Líquido: €\${marriedSingleIncomeDisabled.netSalary.toFixed(2)}\`);`} />
...
console.log(\`Salário Líquido: €\${partnerDisabled.netSalary.toFixed(2)}\`);
...
console.log(\`Salário Líquido: €\${familyWithDisabledDependent.netSalary.toFixed(2)}\`);
