...
Calcula os impostos e o rendimento líquido de trabalhadores por conta de outrem portugueses usando as tabelas de retenção oficiais. Retorna um **breakdown mensal completo** (12 meses), aplicando automaticamente o período fiscal correto para cada mês.
