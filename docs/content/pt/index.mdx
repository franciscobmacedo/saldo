...
- **Trabalhadores por conta de outrem** — Folha de pagamento com tabelas de retenção. Comece com [guia de trabalhador por conta de outrem](/dependent/get-started).
...
- **[Trabalhador por conta de outrem](/dependent/get-started)** - Início rápido específico para folha de pagamento
