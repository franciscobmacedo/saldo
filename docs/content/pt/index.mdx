...
Escolha o caminho:
- **Trabalhadores por conta de outrem** - Processamento salarial com tabelas de retenção. [Começar](/pt/dependent/get-started).
- **Trabalhadores independentes** - Regime simplificado / RNH. [Começar](/pt/independent/get-started).
