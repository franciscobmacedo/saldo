...
Cálculos para trabalhadores independentes (categoria B). Para processamento salarial, veja a [documentação de trabalhador por conta de outrem](/dependent/get-started).
...
- [API de trabalhador independente](/independent/api-reference)
- [Exemplos de trabalhador independente](/independent/examples)
- Para processamento salarial, veja a [documentação de trabalhador por conta de outrem](/dependent/get-started).
