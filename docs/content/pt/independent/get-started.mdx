...
Bem-vindo ao guia de **trabalhador independente** do Saldo. Se precisar de simulações de processamento salarial, vá para a [documentação de trabalhador por conta de outrem](/dependent/get-started).
...
- **`income`** + **`incomeFrequency`**: `'year'` (predefinição), `'month'`, ou `'day'` (dias úteis do ano)
...
- Consulte a [API de trabalhador independente](/independent/api-reference)
- Explore os [exemplos de trabalhador independente](/independent/examples)
- A trabalhar com processamento salarial? Mude para a [documentação de trabalhador por conta de outrem](/dependent/get-started).
