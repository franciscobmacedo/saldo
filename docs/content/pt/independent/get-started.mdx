...
Cálculos para trabalhadores independentes (categoria B). Para processamento salarial, veja a [documentação de trabalhador por conta de outrem](/pt/dependent/get-started).
...
- [API de trabalhador independente](/pt/independent/api-reference)
- [Exemplos de trabalhador independente](/pt/independent/examples)
- Para processamento salarial, veja a [documentação de trabalhador por conta de outrem](/pt/dependent/get-started).
