...
console.log(\`Single - Net: €\${single.net.salary.toFixed(2)}\`);
console.log(\`Married 2 holders - Net: €\${marriedTwoHolders.net.salary.toFixed(2)}\`);
console.log(\`Married with kids - Net: €\${marriedWithKids.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Single Parent - Net: €\${singleParent.net.salary.toFixed(2)}\`);
...
console.log(\`Married Single Income - Net: €\${marriedSingleIncome.net.salary.toFixed(2)}\`);
console.log(\`Married with Kids - Net: €\${marriedWithKids.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Single Disabled - Net: €\${singleDisabled.net.salary.toFixed(2)}\`);
console.log(\`Married Disabled - Net: €\${marriedDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Single Parent Disabled - Net: €\${singleParentDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Married Two Holders Disabled - Net: €\${marriedTwoHoldersDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Married Single Income Disabled - Net: €\${marriedSingleIncomeDisabled.net.salary.toFixed(2)}\`);`} />
...
console.log(\`Net Salary: €\${partnerDisabled.net.salary.toFixed(2)}\`);
...
console.log(\`Net Salary: €\${familyWithDisabledDependent.net.salary.toFixed(2)}\`);
