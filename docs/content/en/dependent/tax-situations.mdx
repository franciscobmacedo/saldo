...
console.log('=== TABLE1 Examples (January) ===');
console.log(\`Single - Net: €\${single.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Married 2 holders - Net: €\${marriedTwoHolders.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Married with kids - Net: €\${marriedWithKids.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);`} />
...
console.log(\`Single Parent - Net: €\${jan.netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Tax Benefits: €\${jan.bracket.deduction.toFixed(2)}\`);`} />
...
console.log('=== TABLE3 Examples (January) ===');
console.log(\`Married Single Income - Net: €\${marriedSingleIncome.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Married with Kids - Net: €\${marriedWithKids.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);`} />
...
console.log('=== TABLE4 Examples (January) ===');
console.log(\`Single Disabled - Net: €\${singleDisabled.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Married Disabled - Net: €\${marriedDisabled.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);`} />
...
console.log(\`Single Parent Disabled - Net: €\${singleParentDisabled.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);`} />
...
console.log(\`Married Two Holders Disabled - Net: €\${marriedTwoHoldersDisabled.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);`} />
...
console.log(\`Married Single Income Disabled - Net: €\${marriedSingleIncomeDisabled.monthlyBreakdown[0].netIncome.totalAmount.toFixed(2)}\`);`} />
...
console.log(\`Net Salary: €\${jan.netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Additional Deduction: €\${jan.bracket.var2_deduction.toFixed(2)}\`);`} />
...
console.log(\`Net Salary: €\${jan.netIncome.totalAmount.toFixed(2)}\`);
console.log(\`Dependent Deduction: €\${jan.bracket.dependent_aditional_deduction.toFixed(2)}\`);`} />
