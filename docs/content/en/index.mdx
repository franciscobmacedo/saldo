...
Pick your path:
- **Dependent workers** - Payroll with retention tables. [Get started](/en/dependent/get-started).
- **Independent workers** - Simplified regime / RNH for self-employed. [Get started](/en/independent/get-started).
