...
### TABLE1_SOLTEIRO_OU_CASADO_2_TITULARES - Single or Married with Two Holders
...
### TABLE4_SOLTEIRO_OU_CASADO_2_TITULARES_SEM_DEPENDENTES_PESSOA_COM_DEF - Single/Two Holders with Disability
...
### TABLE5_SOLTEIRO_UM_OU_MAIS_DEPENDENTES_PESSOA_COM_DEF - Single with Dependents and Disability
...
### TABLE6_CASADO_2_TITULARES_UM_OU_MAIS_DEPENDENTES_PESSOA_COM_DEF - Married Two Holders with Dependents and Disability
...
### TABLE7_CASADO_1_TITULAR_PESSOA_COM_DEF - Married Single Holder with Disability
...
graph TD
    ...
    F -->|No| H[TABLE1_SOLTEIRO_OU_CASADO_2_TITULARES]
    F -->|Yes| I[TABLE2_SOLTEIRO_UM_OU_MAIS_DEPENDENTES]
    
    G -->|1| J{Has Dependents?}
    G -->|2| K{Has Dependents?}
    
    J -->|No/Yes| L[TABLE3_CASADO_1_TITULAR]
    K -->|No| M[TABLE1_SOLTEIRO_OU_CASADO_2_TITULARES]
    K -->|Yes| N[TABLE1_SOLTEIRO_OU_CASADO_2_TITULARES]
    
    C --> O{Married?}
    O -->|No| P{Has Dependents?}
    O -->|Yes| Q{Number of Holders?}
    
    P -->|No| R[TABLE4_SOLTEIRO_OU_CASADO_2_TITULARES_SEM_DEPENDENTES_PESSOA_COM_DEF]
    P -->|Yes| S[TABLE5_SOLTEIRO_UM_OU_MAIS_DEPENDENTES_PESSOA_COM_DEF]
    
    Q -->|1| T[TABLE7_CASADO_1_TITULAR_PESSOA_COM_DEF]
    Q -->|2| U{Has Dependents?}
    U -->|Yes| V[TABLE6_CASADO_2_TITULARES_UM_OU_MAIS_DEPENDENTES_PESSOA_COM_DEF]
    U -->|No| W[TABLE4_SOLTEIRO_OU_CASADO_2_TITULARES_SEM_DEPENDENTES_PESSOA_COM_DEF]
```
...
|-----------|-----------|----------|
| TABLE1_SOLTEIRO_OU_CASADO_2_TITULARES | Standard | Base tax rates |
| TABLE2_SOLTEIRO_UM_OU_MAIS_DEPENDENTES | Lower | Single parent benefits |
| TABLE3_CASADO_1_TITULAR | Lower | Single income household benefits |
